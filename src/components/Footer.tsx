...
export default function Footer() {
  return (
    <footer style={{ borderTop: "1px solid rgba(242,242,242,0.04)" }}>
      <div className="mx-auto max-w-[840px] px-4 md:px-0 pt-16 pb-12">
        <FadeIn y={24}>
          <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-10">
            <div>
              ...
              <span className="block text-[11px] tracking-[0.2px] text-[var(--color-fg-15)] mt-1">
            ...
            <div className="flex gap-14">
              <div>
                <span className="block text-[10px] uppercase tracking-[0.15em] text-[var(--color-fg-15)] mb-3">
                  Main
                </span>
        ...
        <FadeIn delay={0.08} y={16}>
          <div
            className="mt-12 pt-6 flex flex-col md:flex-row md:items-center md:justify-between gap-1"
            style={{ borderTop: "1px solid rgba(242,242,242,0.04)" }}
          >
            <span className="text-[12px] text-[var(--color-fg-15)]">
              &copy; {new Date().getFullYear()} Rouben Ghambaryan
            </span>
